...
class Thing(models.Model):
    ...
    track_stock = models.CharField(max_length=2, default='2')
...
class ThingSku(models.Model):
    id = models.BigAutoField(primary_key=True)
    thing = models.ForeignKey(Thing, on_delete=models.CASCADE, related_name='skus')
...
class BasicSite(models.Model):
    ...
    ga4_enable = models.CharField(max_length=2, default='2')
    ga4_measurement_id = models.CharField(max_length=50, blank=True, null=True)
    meta_pixel_enable = models.CharField(max_length=2, default='2')
    meta_pixel_id = models.CharField(max_length=50, blank=True, null=True)
    tiktok_pixel_enable = models.CharField(max_length=2, default='2')
    tiktok_pixel_id = models.CharField(max_length=50, blank=True, null=True)
...
class ShopSettings(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    enable_stripe = models.CharField(max_length=2, choices=SWITCH_CHOICES, default='1')
    enable_paypal = models.CharField(max_length=2, choices=SWITCH_CHOICES, default='1')
    stripe_secret_key_enc = models.TextField(blank=True, null=True)
    stripe_webhook_secret_enc = models.TextField(blank=True, null=True)
    paypal_env = models.CharField(max_length=16, default='sandbox', blank=True)
    paypal_client_id_enc = models.TextField(blank=True, null=True)
    paypal_client_secret_enc = models.TextField(blank=True, null=True)
    default_currency = models.CharField(max_length=3, default='USD')
    default_shipping_fee = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    home_theme_id = models.CharField(max_length=8, default='001')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
    update_time = models.DateTimeField(auto_now=True, null=True)
...
class Order(models.Model):
    ...
    customer_email = models.CharField(max_length=120, blank=True, null=True)
    customer_phone = models.CharField(max_length=30, blank=True, null=True)
    query_token = models.CharField(max_length=64)
    inventory_deducted = models.CharField(max_length=2, default='2')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
    update_time = models.DateTimeField(auto_now=True, null=True)
...
class OrderItem(models.Model):
    ...
    thing = models.ForeignKey(Thing, on_delete=models.SET_NULL, blank=True, null=True)
    sku = models.ForeignKey(ThingSku, on_delete=models.SET_NULL, blank=True, null=True)
    sku_snapshot = models.CharField(max_length=300, blank=True, null=True)
    title_snapshot = models.CharField(max_length=200, blank=True, null=True)
    cover_snapshot = models.CharField(max_length=1000, blank=True, null=True)
