        ...
        <>
            ...
            <div className="bg-white px-4 py-4 flex flex-col gap-4">
                ...
                <div className=" flex flex-row gap-4">
                    ...
                    <div
                        className={cardStyle}>
                        <div className={labelStyle}>今日订单</div>
                        <div className={valueStyle}>{data.order_today_count || '0'}</div>
                    </div>
                    <div
                        className={cardStyle}>
                        <div className={labelStyle}>今日已支付</div>
                        <div className={valueStyle}>{data.order_paid_today_count || '0'}</div>
                    </div>
                    <div
                        className={cardStyle}>
                        <div className={labelStyle}>今日待支付</div>
                        <div className={valueStyle}>{data.order_pending_today_count || '0'}</div>
                    </div>
                    <div
                        className={cardStyle}>
                        <div className={labelStyle}>今日支付记录</div>
                        <div className={valueStyle}>{data.payment_today_count || '0'}</div>
                    </div>
                </div>
            </div>
